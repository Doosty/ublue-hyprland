...
Read [the README in the `scripts/` directory](https://github.com/Doosty/ublue-hyprland/blob/main/scripts/README.md) for more information.
...
- Then rebase to the signed image, like so:
  ```
  sudo rpm-ostree rebase ostree-image-signed:docker://ghcr.io/Doosty/ublue-hyprland:latest
  ```
...
```
sudo rpm-ostree rebase ostree-image-signed:docker://ghcr.io/Doosty/ublue-hyprland:20230403
```
...
To run the action, simply edit the `boot_menu.yml` by changing all the references to `Doosty/ublue-hyprland` to your repository. This should trigger the action automatically.
